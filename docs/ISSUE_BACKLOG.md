...
This backlog records the remaining work discovered during the v0.2.0 refactor. IDs are stable references for future GitHub issues. Priority is based on security and release risk; an item being listed here does not mean its unsafe behavior is currently enabled.

## P0 — release and security evidence

### SAFE-001: Real Windows end-to-end matrix
...
### SAFE-002: Malicious archive regression corpus
...
### SAFE-004: Backend provenance, SBOM, and license evidence
...
### SAFE-005: Reduce source-tree TOCTOU windows
...
### SAFE-006: Evaluate LPAC and explicit capabilities
...
### SAFE-007: Secure encrypted-archive input
...
### SAFE-008: Defender/antimalware handoff
...
### UX-001: Settings accessibility and integration automation
...
### UX-002: Archive preview without backend privilege expansion
...
### QA-001: Fuzzing and property tests
...
### PORT-001: Windows ARM64 package
