...
Windows 11 ARM from exact `main` commit `5cbc6c27fb67466369b20180a9c5aa2fdd3f6713` in
[Actions run 31868019031](https://github.com/hjosugi/iroha-zip/actions/runs/31868019031). Exact-name local
...
[durable run snapshot](https://github.com/hjosugi/iroha-zip/tree/main/evidence/windows/31868019031)
with an ordinary Rust regression for inventory and security assertions. Periodic promotion of later
reviewed runs remains open; long-term evidence no longer depends only on expiring Actions artifacts.
...
[Actions run 31868019031](https://github.com/hjosugi/iroha-zip/actions/runs/31868019031) exercised the
