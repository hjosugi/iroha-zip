...
iroha-zipはupdaterを出荷しておらず、backgroundでnetworkへ接続しません。`v0.6.3`を含む公式版は
...
`v0.6.3`, are unsigned, so neither a digest nor GitHub release/workflow attestations can authorize
self-update. OPS-001
