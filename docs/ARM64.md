...
`v0.6.3`公開では[Actions run 31887844084](https://github.com/hjosugi/iroha-zip/actions/runs/31887844084)が
成功しました。事前の[非公開dry run 31887126357](https://github.com/hjosugi/iroha-zip/actions/runs/31887126357)と、
tag側[CI run 31887844038](https://github.com/hjosugi/iroha-zip/actions/runs/31887844038)も合格しています。
...
`c99000335f2b64df815f029ff1d7b7d25e31a2c0`、exact tag commit
`c3984c578f4a49f8bea37e0d22df33b7d0483621`、hosted-runner限定の
...
[v0.6.3 release snapshot](https://github.com/hjosugi/iroha-zip/tree/main/evidence/releases/v0.6.3)に保存しています。
...
For the `v0.6.3` publication,
[Actions run 31887844084](https://github.com/hjosugi/iroha-zip/actions/runs/31887844084)
succeeded after [non-publishing dry run 31887126357](https://github.com/hjosugi/iroha-zip/actions/runs/31887126357)
and alongside passing tag [CI run 31887844038](https://github.com/hjosugi/iroha-zip/actions/runs/31887844038).
...
`c99000335f2b64df815f029ff1d7b7d25e31a2c0`, exact tag commit
`c3984c578f4a49f8bea37e0d22df33b7d0483621`, and nine hosted-runner-only tag-ref attestations all
...
[v0.6.3 release snapshot](https://github.com/hjosugi/iroha-zip/tree/main/evidence/releases/v0.6.3).
