...
- Rust／GitHub Actions／JavaScriptのCodeQL `extended`解析を有効化しています。local pathを扱うdesktop CLIとしての初回233件のsink/source確認と、その後のtest限定alert #234の判定は[CodeQL baseline](docs/CODEQL.md)に記録しています。2026-08-14時点のopen alertは0件です。
