# v0.6.1 release evidence / v0.6.1公開証跡

## 日本語

このdirectoryは、未署名のimmutable
[`v0.6.1`](https://github.com/hjosugi/iroha-zip/releases/tag/v0.6.1)を2026-08-15に
...
unsigned, immutable
[`v0.6.1`](https://github.com/hjosugi/iroha-zip/releases/tag/v0.6.1) release.
