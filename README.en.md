...
- CodeQL `extended` analysis is enabled for Rust, GitHub Actions, and JavaScript. [CodeQL baseline](docs/CODEQL.md) records the initial 233 sink/source reviews and classification boundary for a local-path desktop CLI.
