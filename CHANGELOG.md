...
- Resolve MSYS2 backend runtime dependencies through bounded batches of at most 64 `ldd` inputs,
  reject inventories larger than 256 files, and lock both limits into the ordinary PowerShell
  launcher regression instead of starting one shell for every discovered DLL.
